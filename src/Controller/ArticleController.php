...
class ArticleController extends AbstractController
{
    ...
    // plutôt d'instancier la classe Request manuellement
        // je peux utiliser le système d'instanciation automatiquement de symfony pour ça, je lui passe en parametre de méthode
        // le type de la classe voulue, suivie d'une variable dans laquelle je veux que symfony stocke l'instance de la classe
